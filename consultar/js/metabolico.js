document.getElementById('metabolic-form').addEventListener('submit', function (e) {
  ...
  if (factors.includes("liver_conditions")) results.push("Doenças hepáticas podem alterar os níveis de proteínas e eletrólitos.");
  if (factors.includes("exercise")) results.push("Exercícios físicos intensos podem alterar temporariamente os níveis de potássio e magnésio.");
  ...
  medications.forEach(med => {
    ...
    if (med === "insulin") results.push("Insulina pode impactar os níveis de potássio.");
  });
